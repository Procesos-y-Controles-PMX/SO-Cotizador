...
/** Agrupa Chiapas, Veracruz y Tabasco bajo una sola etiqueta en gráficos, filtros y reportes. */
...
/** Compara una región cruda contra el valor unificado del filtro de zona. */
export function matchesDisplayRegion(rawRegion: string | null | undefined, filterZona: string): boolean {
  return displayRegionLabel(rawRegion?.trim() || "Sin región") === filterZona;
}
