...
export default function BorradorBar({
  ...
  if (!borrador) {
    return (
      <div className="neu-raised mt-2 flex h-14 shrink-0 items-center justify-between gap-3 rounded-lg px-4">
  ...
  return (
    <div className="neu-raised mt-2 flex h-16 shrink-0 items-center gap-4 rounded-lg px-3">
